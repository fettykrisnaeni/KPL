      ...
      <?php include"../../templates/sidebar.php"; ?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row page-title-header">
              <div class="col-12">
                <div class="page-header">
                  <h4 class="page-title"><i class="fa fa-bar-chart-o"></i>&emsp;Hasil Survey Per Posisi</h4>
                </div>
              </div>              
            </div>
            ...
            <?php         
              $sql="SELECT DISTINCT posisi from user WHERE level='user'";
              $result = mysqli_query($connection,$sql);             
                      ...
                      while($row = mysqli_fetch_array($result)){
                        ...
                        FROM hasil_survey join user on user.id_user=hasil_survey.id_user where posisi='$row[posisi]' AND YEAR(tanggal_waktu) = YEAR(CURRENT_DATE()) AND MONTH(tanggal_waktu) = MONTH(CURRENT_DATE()) ";
              ...
              <div class="col-md-12 grid-margin">
                <div class="card" style="border: 1px; border-style: solid; border-color: #B0C4DE">
                  <div class="p-4 border-bottom bg-light">
                    <h4 class="card-title mb-0"><b>Grafik Posisi: <?php echo"$row[posisi]";?></b></h4>
                  </div>
                  <div class="card-body">
                    <div class="panel-body">
                      <table id="myHTMLTable<?php echo"$row[posisi]";?>" border="0" cellpadding="5" class="table table-striped">
                        <tr>
                      ...
                      $('#myHTMLTable<?php echo"$row[posisi]";?>').convertToFusionCharts({
                        swfPath: "../../assets/fusion/Charts/",
                        type: "MSColumn3D",
                        data: "#myHTMLTable<?php echo"$row[posisi]";?>",
